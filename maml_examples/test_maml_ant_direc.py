...
#file1 = '../data/local/bugfix-trpo-maml-antdirec200/maml1_fbs40_mbs40_flr_0.1_mlr0.01/itr_575.pkl'
file1 = '../data/local/posticml-trpo-maml-antdirec-200/maml1_fbs20_mbs40_flr_0.1_mlr0.01/itr_575.pkl'
...
initial_params_files = [file1]  #[file1, file2, None, file3]
